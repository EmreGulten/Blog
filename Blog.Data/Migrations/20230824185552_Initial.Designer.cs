...
namespace Blog.Data.Migrations
{
    ...
    [Migration("20230824185552_Initial")]
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d9d6c8bb-c210-454f-88ee-2e26d487b570",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "35fa87e6-4726-4b52-a217-163b863e4a44",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e2b7f705-70f0-4549-961b-9d017f18ddb2",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "534b9ea9-83c5-480a-9d3d-5ecd8f65dcc6",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHA5yqTSPpl9LOkOm3vbH+Xy2AQDZyAGtACDF0P3E4k0Mb3ow1OYGYkCld8IOjeVvQ==",
                            PhoneNumber = "+905439999999",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "f9ee9d82-2f9f-4c8a-ac2e-0f7eb08b7dce",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2984d76f-5d27-4df3-8374-2b1a1bdf1c05",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECuA4ymwXPxWaOeoQCNUUMVZyEgNf4mxU8Z6hewZTuz9I54u9uDQVxTa+c7Q3y7ogA==",
                            PhoneNumber = "+905439999988",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "457f9d86-b09a-44c6-9142-ff4ef073a48f",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c461fb49-94cc-4862-886d-5018beb425a4"),
                            Author = "test",
                            ...
                            CreatedDate = new DateTime(2023, 8, 24, 21, 55, 51, 702, DateTimeKind.Local).AddTicks(9931),
                            ImageId = new Guid("f71f4b9a-aa60-461d-b398-de31001bf214"),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("ea0497b8-ec62-487e-a67b-e1ca057604ac"),
                            Author = "test",
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 24, 21, 55, 51, 702, DateTimeKind.Local).AddTicks(9949),
                            ImageId = new Guid("d16a6ec7-8c50-4ab0-89a5-02b9a551f0fa"),
                            IsDeleted = false,
                            MetaDescription = "test",
                            MetaTitle = "test",
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 24, 21, 55, 51, 703, DateTimeKind.Local).AddTicks(1085),
                            IsDeleted = false,
                            Name = "ASP.NET Core"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 24, 21, 55, 51, 703, DateTimeKind.Local).AddTicks(1088),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 24, 21, 55, 51, 703, DateTimeKind.Local).AddTicks(1178),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 8, 24, 21, 55, 51, 703, DateTimeKind.Local).AddTicks(2455),
